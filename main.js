...
//3. На основе массива скопировать массив пользователей в 
//другой массив сотрудников и добавить им поле зарплата salary.

//Для каждой операции нужно создать функция, которая будет производить вычисления.
